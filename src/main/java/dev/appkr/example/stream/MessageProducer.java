 ...
 */
package dev.appkr.example.stream;

import dev.appkr.example.config.Constants.MessageKey;
import dev.appkr.example.config.Constants.MessagePolicy;
...
import static dev.appkr.example.config.Constants.PROJECT_NAME;
