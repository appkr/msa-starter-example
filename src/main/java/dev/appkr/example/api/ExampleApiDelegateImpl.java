...
import static dev.appkr.example.api.error.ErrorConstants.CONSTRAINT_VIOLATION_TYPE;
import static java.util.Arrays.asList;

import dev.appkr.example.api.error.BadRequestAlertException;
import dev.appkr.example.api.model.ExampleDto;
import dev.appkr.example.api.model.ExampleListDto;
...
public class ExampleApiDelegateImpl implements ExampleApiDelegate {
   ...
   * {
   *   "errorKey": "example/constraint-violation",
   *   "type": "example/problem-with-message",
