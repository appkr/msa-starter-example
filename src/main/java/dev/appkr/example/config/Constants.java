...
public class Constants {
  ...
  public static class LogKey {
    public static final String HTTP_INBOUND_LOGGER = "dev.appkr.example.http.api";
    public static final String HTTP_OUTBOUND_LOGGER = "dev.appkr.example.http.external";
